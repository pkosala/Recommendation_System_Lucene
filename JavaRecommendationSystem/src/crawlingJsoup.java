...
public class crawlingJsoup {
	...
	public static void crawl(String url, String path) throws IOException
	{
		...
		Elements results_a = resultLinks.select("a");
		...
		for(Element ulink : results_a)
		{
			...
			if(ulink.hasText() )
			{
				...
				if(i>6)
				{
				crawlAndLoadText(ulink.attr("href"),ulink.text(),ele.html(),path);
				}
			}
		}
		}

		public static void crawlAndLoadText(String url, String title, String html, String path) throws IOException
		{
